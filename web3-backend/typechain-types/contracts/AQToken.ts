...
export interface AQTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface AQToken extends BaseContract {
  connect(runner?: ContractRunner | null): AQToken;
  waitForDeployment(): Promise<this>;

  interface: AQTokenInterface;
